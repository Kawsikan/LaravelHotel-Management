            ...
            <div class="col-lg-4">
                <form action="/set-catering-order" method="GET">
                    ...
                    <div class="form-row">
                        ...
                        <input type="text" id="name" placeholder="Billing Name" name="name" class="form-control col-sm-8">
                    </div>
                    <br>

                    <div class="form-row">
                        <label  class="col-sm-4 col-form-label" for="name">Your address</label>
                        <input type="text" id="cus_Address" placeholder="Customer address" name="cus_Address" class="form-control col-sm-8">
                    </div>
                    <br>

                    <div class="form-row">
                        <label  class="col-sm-4 col-form-label" for="name">Your email</label>
                        <input type="text" id="email" placeholder="Contact Email" name="email" class="form-control col-sm-8">
                    </div>
                    <br>
                    ...
                    <div class="form-row">
                        ...
                        <input type="text" id="telephone_number" placeholder="Contact Number" name="telephone_number" class="form-control col-sm-8">
                    </div>
                    <br>
                    ...
                    <div class="form-row">
                        ...
                        <input type="datetime-local" id="date_and_time" name="date_and_time" class="form-control col-sm-8">
                    </div>
                    <br>

                    <div class="form-row">
                        <label  class="col-sm-4 col-form-label" for="name">Event Location</label>
                        <input type="text" id="event_location" placeholder="Address of venue" name="event_location" class="form-control col-sm-8">
                    </div>
                    <br>

                    <div class="form-row">
                        <label  class="col-sm-4 col-form-label" for="name">Guests </label>
                        <input type="number" id="event_guests" placeholder="Expected number of Guests" name="event_guests" class="form-control col-sm-8">
                    </div>
                    <br>
