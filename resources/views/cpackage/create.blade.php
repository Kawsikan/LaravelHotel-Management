    ...
    <div>
        ...
        <form method="get" action="/add-package">
            ...
            <div class="form-group">    
                ...
                <input type="text" class="form-control" name="p_name" placeholder="Enter package name" value="{{ old('p_name') }}"/>
                <small id="emailHelp" class="form-text text-muted">Make sure the name does not exist.</small>
            </div>
            <div class="form-group">
