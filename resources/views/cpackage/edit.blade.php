    ...
    <div class="col-sm-8 offset-sm-3">
        ...
        <form method="GET" action="/update-caterpackage/{{$cpackages->id}}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="p_name" class="form-control" name="p_name" value={{ $cpackages->p_name }} />
            </div>
            
            <div class="form-group">
                <label for="description">Description :</label>
                <input type="text" id = "description" class="form-control" name="description" value={{ $cpackages->description }} />
            </div>
            <div class="form-group">
                <label for="price">Price :</label>
                <input type="text" id="price" class="form-control" name="price" value={{ $cpackages->price }} />
            </div>
